...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Creado tu cuenta en Club de festejos Merina, con el usuario ". $this->email. " solo debes confirmarla presionando el siguiente enlace</p>";
         $contenido .= "<p>Presiona aquí: <a href='https://peaceful-lake-26132.herokuapp.com/confirmar-cuenta?token=" . $this->token . "'>Confirmar Cuenta</a>";        
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='https://peaceful-lake-26132.herokuapp.com/recuperar?token=" . $this->token . "'>Reestablecer Password</a>";        
        $contenido .= "<p>Si tu no solicitaste este cambio, puedes ignorar el mensaje</p>";
        $contenido .= '</html>';
        $mail->Body = $contenido;
